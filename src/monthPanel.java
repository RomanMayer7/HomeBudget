...
public class monthPanel extends JPanel{
	...
	public monthPanel(String x,final JInternalFrame frame,MainFrame mainframe){
		...
		if(cpf.exists()==false){ //initial population of table in case Checkpoint.dat still not exist
		...
		for (int i=0;i<mainTableData.size();i++){   //adding tables entries from collection into array
	...
	if(cpf_p.exists()==true){ 	
		...
		for (int i=0;i<purchTableData.size();i++){   //adding tables entries from collection into array
...
//*********************************************************************************************************	
	public void saveTable(){
		...
		if (cpf.exists()==false){///If "Checkpoint.dat"  file not exist -create him
		cpf.createNewFile();		
		}
...
//*********************************************************************************************************
	public void saveTable2(){
		...
		if (cpf_p.exists()==false){///If "Checkpoint_p.dat"  file not exist -create him
		cpf_p.createNewFile();		
		}
		}catch(FileNotFoundException e){System.out.println("File not found");}
		catch(IOException e){System.out.println("an problem is occured");}}
